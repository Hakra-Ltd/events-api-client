...
class EventDateSchema(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["event_id", "timezone_date_time"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EventDateSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EventDateSchema from a dict"""
        if obj is None:
            return None
